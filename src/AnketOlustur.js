...
import { FaBars, FaUser, FaChartBar, FaClipboardList, FaSignOutAlt, FaHome } from "react-icons/fa";
...
function AnketOlustur() {
  ...
  const handleSifirdanAnket = () => navigate("/sifirdan-anket");
  const handleYapayZeka = () => navigate("/ai-ile-anket");
