...
function AnketKopyala() {
    ...
    // --- WIZARD STATE ---
    const [currentStep, setCurrentStep] = useState(1); // 1: Select, 2: Rename, 3: Questions, 4: Audience, 5: Success
    ...
    const handleTemplateSelect = (template) => {
        ...
        setCurrentStep(2); // Go to Rename step
    };
        ...
        <div className="wizard-page panel-container">
            ...
            <nav className="panel-navbar">
                <div className="nav-left">
                    ...
                    <span className="panel-logo">AnketApp <span className="logo-badge copy-badge">KOPYA</span></span>
                </div>
            ...
            <div className={`sidebar ${menuOpen ? "open" : ""}`}>
                <div className="sidebar-header">
                    <div className="sidebar-logo">📋 Anket Kopyala</div>
                </div>
                <ul>
                    <li onClick={() => navigate('/panel')}><FaChartBar className="icon" /> Dashboard</li>
                    <li className="active"><FaCopy className="icon" /> Anketi Kopyala</li>
            ...
            <main className="wizard-main">
                ...
                {currentStep < 5 && (
                    <div className="wizard-stepper">
                        <div className={`step-item ${currentStep >= 1 ? 'active' : ''} ${currentStep > 1 ? 'completed' : ''}`}>
                            <div className="step-number">{currentStep > 1 ? <FaCheckCircle /> : <FaCopy />}</div>
                            <div className="step-label">Anket Seç</div>
                        </div>
                        <div className="step-connector"></div>
                        <div className={`step-item ${currentStep >= 2 ? 'active' : ''} ${currentStep > 2 ? 'completed' : ''}`}>
                            <div className="step-number">{currentStep > 2 ? <FaCheckCircle /> : "2"}</div>
                            <div className="step-label">Yeni Bilgiler</div>
                        </div>
                        <div className="step-connector"></div>
                ...
                <div className="wizard-content-area">
                    ...
                    {/* STEP 3: QUESTIONS (Same as SifirdanAnket) */}
                    {currentStep === 3 && (
                    ...
                    {/* STEP 4: AUDIENCE (Same as SifirdanAnket) */}
                    {currentStep === 4 && (
